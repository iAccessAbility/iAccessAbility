...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        document.getElementById("quiz-container").innerHTML = `
            ...
            <br>
            <button class="site-button" onclick='resetGame()'>Play Again</button>
            <br>
            <button class="site-button" onclick='goBack()'>Go Back</button>
        `;
    }
}
// Resets game
function resetGame() {
    ...
    document.getElementById("quiz-container").innerHTML = `
        ...
        <div id="fun-fact" class="hidden">
            <p id="fact"></p>
            <button class="site-button" onclick="nextQuestion()">Next</button>
        </div>
    `;
    displayQuestion();
}
